...
def get_file_path_from_package_installation(file_path_inside) -> None|str:
    ...
    full_file_path = realpath(os.path.join(loc_dir, file_path_inside))
...
def print_red(text, *args, **kwargs):
    print(colored(text, "red"), *args, **kwargs)


def print_green(text, *args, **kwargs):
    print(colored(text, "green"), *args, **kwargs)


def print_dark_grey(text, *args, **kwargs):
    print(colored(text, "dark_grey"), *args, **kwargs)